...
exports.security = require("./security/sanitizer");

/**
 * Access to the extensible element handler registry
 * Allows registration of custom handlers for unsupported document elements
 *
 * @example
 * // Register a custom handler for a specific element
 ...
 *   return [Html.text("Fallback for: " + element.name)];
 * });
 */
exports.handlers = elementHandlerRegistry;
...
// Document Chunking and Navigation System
exports.documentChunking = require("./document-chunking");
exports.chunkingIntegration = require("./document-chunking-integration");
